package com.liudehuang.sentinel.cluster.embedded.config;
...
import com.liudehuang.sentinel.cluster.embedded.constants.DemoConstants;
import com.liudehuang.sentinel.cluster.embedded.entity.ClusterGroupEntity;
...
public class EmbeddedClusterInitFunc implements InitFunc {
    ...
    private void initDynamicRuleProperty() {
        ...
        ruleSource = new NacosDataSource<>(remoteAddress, groupId,
