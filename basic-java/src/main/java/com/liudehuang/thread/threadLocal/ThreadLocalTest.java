package com.liudehuang.thread.threadLocal;

/**
 * @Description:
 * @Author: liudh
 * @CreateDate: 2020/8/11 17:58
 * @UpdateUser: liudh
 * @UpdateDate: 2020/8/11 17:58
 * @UpdateRemark:
 * @Version:
 * ThreadLocal :threadLocal为每个线程访问共享变量都提供了共享变量副本，threadLocal是线程安全的
 */
